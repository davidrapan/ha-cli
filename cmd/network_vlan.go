...
func init() {
	...
	networkVlanCmd.Flags().String("ipv6-addr_gen_mode", "", "IPv6 address generation mode: eui64|stable-privacy")
	...
	networkVlanCmd.RegisterFlagCompletionFunc("ipv6-addr_gen_mode", ipAddrGenModeCompletions)
